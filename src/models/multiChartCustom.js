nv.models.multiChart = function() {
  ...
  var x = d3.scale.linear(),
      ...
      stack1 = nv.models.stackedArea().yScale(yScale1), //.hideable(true),
      stack2 = nv.models.stackedArea().yScale(yScale2), //.hideable(true),
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      // Hide the y2 axis when it is not used
      if (series2.length > 0) {
